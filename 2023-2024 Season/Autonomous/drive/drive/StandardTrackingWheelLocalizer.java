...
import org.firstinspires.ftc.teamcode.Autonomous.util.util.Encoder;
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.2*0.94; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 3.6; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;

    public static double X_MULTIPLIER = 0.998; // Multiplier in the X direction
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        ...
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "left back"));
